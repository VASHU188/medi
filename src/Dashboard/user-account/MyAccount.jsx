        ...
        {error && !loading && <Error errMessage={error}/>}
    {
      !loading && !error && <div className='grid md:grid-cols-3 gap-10'> 
        ...
        <div className='col-span-2 md:px-[20px]'>
          <div>
            <button onClick={() => setTab('bookings')} className={`w-auto p-2 mr-5 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor ${tab === 'bookings' ? 'bg-primaryColor text-white font-normal' : ''}`}>My Booking</button>
