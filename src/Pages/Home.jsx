          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                we understand the importance of quality healthcare, especially when it comes to Medicare.
                 Our team of dedicated and experienced doctors is committed to providing personalized and
                  compassionate medical care to our Medicare patients.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                We understand the importance of finding a doctor who meets your unique healthcare needs.
                Your health is our priority, and we look forward to providing you with the personalized care you deserve.
                </p>
                <Link
                  to="/doctors"
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                We are committed to making healthcare accessible and convenient for you.
                Your health is our priority, and our multiple locations are designed to provide you with easy access to top-notch healthcare services.
                </p>
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none "
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                we value your time and prioritize your health. 
                Booking an appointment with us is easy and convenient, ensuring that you receive the personalized healthcare you deserve without the hassle.
                </p>
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none "
